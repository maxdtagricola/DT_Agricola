/*=========================================================
    ...
    casa cada linha com o catálogo pela "referencia":
      - se já existe: só atualiza a disponibilidade, calculada
        a partir da "quantidade" (>0 = Em estoque, <=0 = Indisponível)
        ...
        for (let inicio = 0; inicio < validas.length; inicio += TAMANHO_LOTE) {
            ...
            fatia.forEach(l => {
                ...
                if (l.acao === "novo") {
                    ...
                    lote.set(ref, {
                        ...l.dadosNovoProduto,
                        nomeBusca: Utils.limparTexto(l.dadosNovoProduto.nome),
                        referenciaBusca: Utils.limparTexto(l.dadosNovoProduto.referencia),
